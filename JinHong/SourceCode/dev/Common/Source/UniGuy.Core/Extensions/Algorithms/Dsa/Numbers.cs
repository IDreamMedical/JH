...
namespace UniGuy.Core.Extensions.Algorithms.Dsa
{
    ...
    public static class Numbers
    {
...
#endif
        {
            Guard.OutOfRange(number < 0, "number", Resource.FibonacciLessThanZero);
...
#endif
        {
            Guard.OutOfRange(number < 0, "number", Resource.FactorialLessThanZero);
        ...
        {
            Guard.OutOfRange(exponent < 0, "exponent", Resource.PowerExponentLessThanZero);
...
#endif
        {
            Guard.OutOfRange(value < 0, "value", Resource.ToBaseNIntNegative);
...
#else
            return Int32.Parse(Strings.Reverse(sb.ToString()), CultureInfo.InvariantCulture);
#endif
        }
...
#else
        public static int ToOctal(int value)
#endif
        {
            Guard.OutOfRange(value < 0, "value", Resource.ToBaseNIntNegative);
...
#endif
        {
            ...
            return Strings.Reverse(sb.ToString());
        }
