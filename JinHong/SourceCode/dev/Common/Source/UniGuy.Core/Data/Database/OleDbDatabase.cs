...
namespace UniGuy.Core.Data
{
    ...
    public class OleDbDatabase : IDatabase
    {
        ...
        /// <returns></returns>
        public bool Test(OleDbConnection conn)
        {
            if (conn == null)
                return false;
        ...
        /// OleDb连接列表
        /// </summary>
        private Dictionary<string, OleDbConnection> conns;
        ...
        /// 获得或者设置OleDb连接列表
        /// </summary>
        public Dictionary<string, OleDbConnection> Conns
        {
            get { return conns; }
            set { conns = value; }
        }
        ...
        /// <returns></returns>
        /// Depricated
        public OleDbCommand CreateCommand2(string connectionString, string sql, SqlParameterDictionary parameters)
        {
        ...
        private void SqlizeCommand(OleDbCommand comm, string sql, SqlParameterDictionary parameters)
        {
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public OleDbCommand CreateCommand(string connectionString, string sql, SqlParameterDictionary parameters)
        {
            OleDbCommand comm = new OleDbCommand();
            comm.Connection = GetConnection(connectionString);
        ...
        public OleDbCommand CreateCommand(IDbTransaction tran, string sql, SqlParameterDictionary parameters)
        {
            OleDbCommand comm = new OleDbCommand();
            comm.Connection = (OleDbConnection)tran.Connection;
            comm.Transaction = (OleDbTransaction)tran;
        ...
        public void OnDatabaseException(OleDbException ex)
        {
        ...
        public void OnDatabaseException(OleDbException ex, OleDbCommand command)
        {
