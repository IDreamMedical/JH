...
namespace UniGuy.Report
{
    public class PdfExporter
    {
        ...
        public void Export2Pdf(DataTable table, string title, string fileName)
        {
            PDFform pdfForm = new PDFform(table, title);
    ...
    public class PDFform
    {
        ...
        /// </summary>
        public PDFform(DataTable table, string title)
        {
            dt = table;
            this.title = title;
        }
