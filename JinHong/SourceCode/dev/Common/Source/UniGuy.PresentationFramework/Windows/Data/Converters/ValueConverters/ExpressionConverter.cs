...
using UniGuy.Core.Expressions;
using UniGuy.Core.Expressions.Nodes;
...
namespace UniGuy.Controls.Converters
{
	...
	/// <see cref="UniGuy.Controls.Converters.Markup.ExpressionConverterExtension"/>. This is so I can add property and type
	...
	internal sealed class ExpressionConverter : DependencyObject, IValueConverter, IMultiValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
		{
			if(_expressionNode == null)
                throw new Exception("NoExpression");
