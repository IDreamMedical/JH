...
#else
        public static IList<T> BubbleSort<T>(IList<T> list, SortType sortType)
#endif
        {
...
#else
        public static IList<T> MedianLeft<T>(IList<T> list)
#endif
        {
            Guard.ArgumentNull(list, "list");
...
#else
        public static IList<T> QuickSort<T>(IList<T> list)
#endif
        {
            Guard.ArgumentNull(list, "list");
...
#else
        public static IList<T> InsertionSort<T>(IList<T> list)
#endif
        {
            Guard.ArgumentNull(list, "list");
...
#else
        public static IList<T> ShellSort<T>(IList<T> list)
#endif
        {
            Guard.ArgumentNull(list, "list");
...
#else
        public static IList<string> RadixSort(IList<string> list, int keySize)
#endif
        {
            Guard.ArgumentNull(list, "list");
            Guard.OutOfRange(keySize < 1, "keySize", Resource.RadixKeySizeTooSmall);
            Guard.InvalidOperation(list[0] == null, Resource.RadixItemNullInList);
