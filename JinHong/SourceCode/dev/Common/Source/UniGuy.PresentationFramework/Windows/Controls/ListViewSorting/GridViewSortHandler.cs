...
namespace UniGuy.Windows.Controls
{
    ...
    public class GridViewSortHandler
    {
        ...
        private static void RegisterSortHandler(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
        ...
        private static void OnColumnHeaderClicked(object sender, RoutedEventArgs e)
        {
            ...
            if (headerClicked != null && headerClicked.Role != GridViewColumnHeaderRole.Padding)
            {
                ...
                if (sortableGridViewColumn!=null && sortableGridViewColumn.CanSort)
