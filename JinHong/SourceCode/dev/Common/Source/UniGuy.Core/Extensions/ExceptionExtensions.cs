...
namespace UniGuy.Core.Extensions
{
    ...
    public static class ExceptionExtensions
    {
        ...
        //  非正式, 同时有Globalization问题等. 20140612
        #region Not so normal
        public static string GetFullMessage(this Exception @this)
        {
            ...
            while (ex != null)
            {
                sb.Insert(0, string.Format(@"Message: {0}{1}{0}StackTrace: {0}{2}{0}", Environment.NewLine, ex.Message, ex.StackTrace));
