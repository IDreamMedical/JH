...
namespace UniGuy.Controls.Behaviors
{
    ...
    //
    public class ExtendedAdorner:Adorner
    {
        internal VisualCollection children;

        /// <summary>
        /// The framework element that is the adorner.
        /// </summary>
        public static readonly DependencyProperty AdornerItemsProperty
            = DependencyProperty.Register("AdornerChildren", typeof(IEnumerable<FrameworkElement>), typeof(ExtendedAdorner));
        ...
        public static readonly DependencyProperty AdornedElementProperty =
            DependencyProperty.RegisterAttached("AdornedElement", typeof(FrameworkElement), typeof(ExtendedAdorner));
        /// <summary>
        ...
        public static readonly DependencyProperty PositionXProperty =
            DependencyProperty.RegisterAttached("PositionX", typeof(double), typeof(ExtendedAdorner),
        ...
        public static readonly DependencyProperty PositionYProperty =
            DependencyProperty.RegisterAttached("PositionY", typeof(double), typeof(ExtendedAdorner),
            new PropertyMetadata(Double.NaN));
        /// <summary>
        ...
        public ExtendedAdorner(IEnumerable<FrameworkElement> adornerChildren, FrameworkElement adornedElement)
            : base(adornedElement)
        {
        ...
        {
            AdornerPlacement horizontalPlacement = ExtendedAdornerBehavior.GetHorizontalPlacement(adornerChild);
            double offsetX = ExtendedAdornerBehavior.GetOffsetX(adornerChild);
        ...
        {
            AdornerPlacement verticalPlacement = ExtendedAdornerBehavior.GetVerticalPlacement(adornerChild);
            double offsetY = ExtendedAdornerBehavior.GetOffsetY(adornerChild);
