...
namespace UniGuy.Core.Extensions
{
    ...
    public static class ObjectExtensions
    {
        ...
        /// <returns></returns>
        public static string ToStringDump(this object o, BindingFlags flags, int maxArrayElements)
        {
            return ToStringDumpInternal(o.ToXElement(flags, maxArrayElements)).Aggregate(String.Empty, (str, el) => str + el);
        }
        public static string ToStringDump(this object o, BindingFlags flags)
        {
            return ToStringDump(o, flags, 5);
        }
        public static string ToStringDump(this object o)
        {
            return ToStringDump(o, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        }
        ...
        /// <param name = "maxArrayElements">Number of elements to show for IEnumerables</param>
        /// <returns></returns>
        public static XElement ToXElement(this object o, BindingFlags flags, int maxArrayElements)
        {
            try
            {
        ...
        public static XElement ToXElement(this object o, BindingFlags flags)
        {
            return ToXElement(o, flags, 5);
        }
        public static XElement ToXElement(this object o)
        {
            return ToXElement(o, BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
        }
        ...
        /// <summary>
        /// 确保某个对象存在,如果不存在则实例化一个对象给他
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="obj"></param>
        /// <returns></returns>
        public static T EnsureExists<T>(this T obj)
        {
            if (obj == null)
            {
    ...
    #region WJ appended
        ...
        {
            return value.ConvertTo(targetType, targetType.GetDefaultValueOfType());
        }
        ...
        public static object ConvertTo(this object value, Type targetType, object defaultValue, bool ignoreException)
        {
            if (ignoreException)
            {
                try
        ...
        /// <summary>
        /// 转换为字符串表示,如果为null则直接返回null,不会报错
        /// </summary>
        /// <param name="this"></param>
        /// <returns></returns>
        public static string ToStringEx(this object @this)
        {
            return ValueRepresentsNull(@this) ? null : @this.ToString();
        }
        /// <summary>
        /// 转换为字符串表示,如果为null则直接返回nullValue
        /// </summary>
        /// <param name="this"></param>
        /// <param name="nullValue"></param>
        /// <returns></returns>
        public static string ToStringEx(this object @this, string nullValue)
        {
            return ValueRepresentsNull(@this) ? nullValue : @this.ToString();
        }
        ...
        /// <returns></returns>
        public static bool ValueRepresentsNull(this object value)
        {
            return value == null || value == DBNull.Value;
        }

        /// <summary>
        /// Check if it is default value of its type.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="value"></param>
        /// <returns></returns>
        ...
        /// <returns></returns>
        public static bool EqualsEx(this object @this, object other)
        {
        ...
        /// <summary>
        /// 设置属性, 不过和SetPropertyValue不同的是, 这里的值是字符串而实际属性类型未知
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="propertyName"></param>
        /// <param name="strValue"></param>
        /// <remarks>枚举类型好像不能使用Convert.ChangeType, TODO</remarks>
        public static void SetPropertyValueWithString(this object obj, string propertyName, string strValue)
        {
        ...
        public static string GetPropertyValueAsString(this object obj, string propertyName)
        {
            ...
            var value = property.GetValue(obj, null);
            return (string)Convert.ChangeType(value, property.PropertyType);
        }
    ...
    #region // Edge.Extensions
        ...
        /// <param name="defaultValue">The default value.</param>
        /// <returns>The target type</returns>
        public static T ConvertTo_2<T>(this object value, T defaultValue)
        {
            if (value != null)
            {
                var targetType = typeof(T);
