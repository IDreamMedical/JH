...
namespace JinHong.Model
{
    ...
    public class FireFightingEquipmentInfo : EntityBase, IIdObject, INamedObject, IDescribable, ICloneable
    {
        #region Fields
        ...
        public object Clone()
        {
            return new FireFightingEquipmentInfo(Guid.NewGuid().ToString())
            {
                Name = this.Name,
                Description = this.Description,
                BuildingId = this.BuildingId,
                FireFightingBox = this.FireFightingBox,
                CarbonDioxideExtinguisher = this.CarbonDioxideExtinguisher,
                Weight = this.Weight,
                DryChemicalExtinguisher = this.DryChemicalExtinguisher,
                FireHydrant = this.FireHydrant,
                FireHose = this.FireHose,
                FireBranch = this.FireBranch,
                OutdoorFireHydrant = this.OutdoorFireHydrant,
                FirePumpRoom = this.FirePumpRoom,
                Notes = this.Notes
            };
        }

        public void CopyProperties(FireFightingEquipmentInfo other)
        {
            this.Name = other.Name;
            this.Description = other.Description;
            this.BuildingId = other.BuildingId;
            this.FireFightingBox = other.FireFightingBox;
            this.CarbonDioxideExtinguisher = other.CarbonDioxideExtinguisher;
            this.Weight = other.Weight;
            this.DryChemicalExtinguisher = other.DryChemicalExtinguisher;
            this.FireHydrant = other.FireHydrant;
            this.FireHose = other.FireHose;
            this.FireBranch = other.FireBranch;
            this.OutdoorFireHydrant = other.OutdoorFireHydrant;
            this.FirePumpRoom = other.FirePumpRoom;
